...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(fieldName) =>
      "${fieldName} o comprimento não deve ser menor que 3.";
  ...
  static String m14(country) => "${country} país não é compatível";

  static String m15(currency) => "${currency} não é compatível";

  static String m16(day) => "${day} dias atrás";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Termina em ${timeLeft}";

  static String m19(captcha) => "Insira ${captcha} para confirmar:";

  static String m20(message) => "Erro: ${message}";

  static String m21(message) => "Erro: ${message}";

  static String m22(time) => "Expirando em ${time}";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour} horas atrás";
  ...
  static String m31(minute) => "${minute} minutos atrás";

  static String m32(month) => "${month} meses atrás";
  ...
  static String m37(amount) => "Pague ${amount}";
  ...
  static String m42(percent) => "Poupe ${percent}%";
  ...
  static String m46(second) => "${second} segundos atrás";
  ...
  static String m54(balance) => "Saldo da carteira: ${balance}";

  static String m55(message) => "Aviso: ${message}";
  ...
  static String m57(length) => "Encontramos ${length} produtos";

  static String m58(week) => "Semana ${week}";

  static String m59(name) => "Bem-vindo ${name}";

  static String m60(year) => "${year} anos atrás";

  static String m61(count) => "Você está selecionando ${count} item(ns)";

  static String m62(total) => "O pedido nº${total} foi atribuído";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "myRating": MessageLookupByLibrary.simpleMessage("Minha classificação"),
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Revisões pendentes"),
