...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(fieldName) =>
      " Længden på${fieldName} må ikke være mindre end 3.";
  ...
  static String m13(count) => "${count} elementer";

  static String m14(country) => "${country} land understøttes ikke";
  ...
  static String m41(count) =>
      "Vil du fjerne ${count} element(er) fra din ønskeliste?";
  ...
  static String m55(message) => "Advarsel: ${message}";
  ...
  static String m57(length) => "Vi fandt ${length} produkter";

  static String m58(week) => "Uge ${week}";

  static String m59(name) => "Velkommen ${name}";

  static String m60(year) => " for${year} år siden";

  static String m61(count) => "Du vælger ${count} element(er)";

  static String m62(total) => "Du har tildelt ordrenummer${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Afventer anmeldelser"),
        ...
        "removeWishlist":
            MessageLookupByLibrary.simpleMessage("Fjern fra ønskeseddel"),
        ...
        "selectItem": MessageLookupByLibrary.simpleMessage("Vælg element"),
