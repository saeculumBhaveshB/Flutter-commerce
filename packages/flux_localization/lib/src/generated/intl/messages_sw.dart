...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(number) => " Zimesalia herufi${number} ";
  ...
  static String m11(count) => "${count} vitu";

  static String m12(count) => "${count} kipengee";

  static String m13(count) => "${count} vipengee";

  static String m14(country) => "${country} nchi haitumiki";
  ...
  static String m48(numberOfUnitsSold) => "Zinauzwa: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m50(total) => "${total} bidhaa";
  ...
  static String m53(date) => "Inatumika hadi ${date}";

  static String m54(balance) => "Salio la Wallet: ${balance}";

  static String m55(message) => "Onyo: ${message}";
  ...
  static String m57(length) => "Tulipata bidhaa ${length} ";

  static String m58(week) => "Wiki ${week}";

  static String m59(name) => "Karibu ${name}";

  static String m60(year) => " miaka${year} iliyopita";

  static String m62(total) => "Umekabidhi kuagiza #${total}";
