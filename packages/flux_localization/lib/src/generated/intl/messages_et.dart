...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(currency) => "Vahetas valuuta ${currency} vastu";
  ...
  static String m12(count) => "${count} üksus";

  static String m13(count) => "${count} üksust";

  static String m14(country) => "${country} riiki ei toetata";

  static String m15(currency) => "${currency} ei ole toetatud";
  ...
  static String m19(captcha) => "Sisestage ${captcha} kinnitamiseks:";
  ...
  static String m33(store) => "Rohkem ${store} poest";

  static String m34(number) => "tuleb osta rühmadena ${number}";
  ...
  static String m38(name) => "${name} on edukalt ostukorvi lisatud";
  ...
  static String m44(keyword, count) => "${keyword} (${count} üksus)";

  static String m45(keyword, count) => "${keyword} (${count} üksust)";
  ...
  static String m49(fieldName) => "${fieldName} väli on kohustuslik";

  static String m50(total) => "${total} toodet";

  static String m51(name) => "Kandke raha üle ${name}";
  ...
  static String m53(date) => "Kehtiv kuni ${date}";

  static String m54(balance) => "Walleti saldo: ${balance}";

  static String m55(message) => "Hoiatus: ${message}";
  ...
  static String m57(length) => "Leidsime ${length} toodet";

  static String m58(week) => "Nädal ${week}";

  static String m59(name) => "Tere tulemast, ${name}";

  static String m60(year) => "${year} aastat tagasi";

  static String m62(total) => "Olete määranud tellimusele #${total}";
