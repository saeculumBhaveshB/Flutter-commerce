...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} לא יכול להיות ריק.";

  static String m6(fieldName) => " אורך${fieldName} לא יכול להיות פחות מ-3.";
  ...
  static String m14(country) => " מדינה${country} אינה נתמכת";

  static String m15(currency) => "${currency} אינו נתמך";

  static String m16(day) => "לפני {יום} ימים";

  static String m17(total) => "~${total} ק\"מ";

  static String m18(timeLeft) => "מסתיים בעוד ${timeLeft}";

  static String m19(captcha) => "הזן ${captcha} כדי לאשר:";
  ...
  static String m23(total) => ">${total} ק\"מ";

  static String m24(hour) => "לפני {שעה} שעות";

  static String m25(currentBalance) => "נשאר לך רק ${currentBalance} בארנק שלך";
  ...
  static String m31(minute) => "לפני {דקה} דקות";

  static String m32(month) => " לפני${month} חודשים";

  static String m33(store) => "עוד מ- ${store}";

  static String m34(number) => "יש לקנות בקבוצות של ${number}";
  ...
  static String m38(name) => "${name} נוספו לעגלת הקניות בהצלחה";

  static String m39(total) => "כמות: ${total}";

  static String m40(name) => "קיבל כסף מ- ${name}";

  static String m41(count) =>
      "האם ברצונך להסיר ${count} פריטים מרשימת המשאלות שלך?";
  ...
  static String m54(balance) => "יתרת ארנק: ${balance}";

  static String m55(message) => "אזהרה: ${message}";

  static String m56(defaultCurrency) =>
      "המטבע שנבחר כרגע אינו זמין עבור תכונת הארנק, שנה אותו ל- ${defaultCurrency}";

  static String m57(length) => "מצאנו ${length} מוצרים";

  static String m58(week) => "שבוע ${week}";

  static String m59(name) => "ברוך הבא ${name}";

  static String m60(year) => " לפני${year} שנים";

  static String m61(count) => "אתה בוחר ${count} פריטים";

  static String m62(total) => "הקצית להזמין מספר${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("המשך לבחור פריט"),
        "continueToShipping":
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("ממתינים לביקורות"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("לדרג"),
        ...
        "waiting": MessageLookupByLibrary.simpleMessage("הַמתָנָה"),
