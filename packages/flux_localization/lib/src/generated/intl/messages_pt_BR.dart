...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m14(country) => "${country} país não é suportado";
  ...
  static String m36(price) => "Opções no total: ${price}";
  ...
  static String m42(percent) => "Venda ${percent}%";
  ...
  static String m53(date) => "Valid til ${date}";
  ...
  static String m57(length) => "Encontrámos ${length} produtos";
  ...
  static String m62(total) => "Você atribuiu a ordem #${total}";
