...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(fieldName) =>
      "${fieldName} La longitud no debe ser inferior a 3.";
  ...
  static String m14(country) => "${country} país no esta disponible";

  static String m15(currency) => " ${currency} no esta disponible";
  ...
  static String m19(captcha) => "Introduzca ${captcha} para confirmar:";
  ...
  static String m28(size) => "Tamaño máximo de archivo: ${size} MB";
  ...
  static String m40(name) => "Recibí dinero de ${name}";

  static String m41(count) =>
      "¿Quieres eliminar ${count} artículo(s) de tu lista de deseos?";

  static String m42(percent) => "Rebaja ${percent} %";
  ...
  static String m54(balance) => "Saldo de la billetera: ${balance}";

  static String m55(message) => "Advertencia: ${message}";
  ...
  static String m57(length) => "Encontramos ${length} productos";

  static String m58(week) => "Semana ${week}";

  static String m59(name) => "Bienvenido ${name}";

  static String m60(year) => " Hace ${year} años";

  static String m61(count) => "Estás seleccionando ${count} artículo(s)";

  static String m62(total) => "Has asignado a la orden #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "Continuar seleccionando el elemento"),
        "continueToShipping":
        ...
        "images": MessageLookupByLibrary.simpleMessage("Imagenes"),
        ...
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("Se requiere iniciar sesión"),
        "loginSuccess":
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("Para calificar"),
