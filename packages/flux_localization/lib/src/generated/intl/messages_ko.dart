...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} 은 비워둘 수 없습니다.";

  static String m6(fieldName) => "${fieldName} 길이는 3보다 작아서는 안 됩니다.";

  static String m7(currency) => "통화를 ${currency}(으)로 변경했습니다.";

  static String m8(number) => "${number} 자 남음";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} 포인트";

  static String m10(count) => " ${count} 항목";

  static String m11(count) => " ${count} 항목";

  static String m12(count) => "${count} 개 항목";

  static String m13(count) => "${count} 개 항목";

  static String m14(country) => "${country} 국가는 지원되지 않습니다";

  static String m15(currency) => "${currency} 은(는) 지원되지 않습니다";

  static String m16(day) => "${day} 일 전";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => " ${timeLeft}로 끝남";

  static String m19(captcha) => "확인하려면 ${captcha} 을(를) 입력합니다.";
  ...
  static String m25(currentBalance) => "지갑에 ${currentBalance} 만 남았습니다.";
  ...
  static String m33(store) => " ${store}에서 더보기";

  static String m34(number) => " ${number}그룹으로 구매해야 합니다.";

  static String m35(itemCount) => "${itemCount} 항목";

  static String m36(price) => "총 옵션 : ${price}";

  static String m37(amount) => " ${amount}지불";

  static String m38(name) => "${name} 이(가) 장바구니에 성공적으로 추가되었습니다";

  static String m39(total) => "수량: ${total}";

  static String m40(name) => " ${name}에서 돈을 받았습니다.";

  static String m41(count) => "위시리스트에서 ${count} 개의 항목을 제거하시겠습니까?";

  static String m42(percent) => "판매 ${percent} %";

  static String m43(keyword) => "검색 결과: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} 개 항목)";

  static String m45(keyword, count) => "${keyword} (${count} 개 항목)";

  static String m46(second) => "${second} 초 전";

  static String m47(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m48(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m49(fieldName) => " ${fieldName} 필드는 필수 항목입니다.";

  static String m50(total) => "${total} 제품";

  static String m51(name) => " ${name}로 송금";
  ...
  static String m54(balance) => "지갑 잔액: ${balance}";

  static String m55(message) => "경고 : ${message}";

  static String m56(defaultCurrency) =>
      "현재 선택한 통화는 지갑 기능에 사용할 수 없습니다. ${defaultCurrency}(으)로 변경하십시오.";

  static String m57(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m58(week) => "주 ${week}";

  static String m59(name) => "환영합니다 ${name}";

  static String m60(year) => "${year} 년 전";

  static String m61(count) => " ${count} 개의 항목을 선택하고 있습니다.";

  static String m62(total) => "주문 번호${total}에 할당했습니다.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("계속해서 항목을 선택하세요"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("이미지를 다운로드하는 중..."),
        ...
        "pendingReviews": MessageLookupByLibrary.simpleMessage("보류 중인 리뷰"),
        ...
        "removeWishlist": MessageLookupByLibrary.simpleMessage("위시리스트에서 제거"),
        ...
        "selectItem": MessageLookupByLibrary.simpleMessage("아이템 선택"),
        ...
        "shareProductData": MessageLookupByLibrary.simpleMessage("제품 데이터 공유"),
        "shareProductLink": MessageLookupByLibrary.simpleMessage("제품 링크 공유"),
