...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} ne peut pas être vide.";

  static String m6(fieldName) =>
      "La longueur de${fieldName} ne doit pas être inférieure à 3.";
  ...
  static String m11(count) => " ${count} éléments";

  static String m12(count) => "${count} article";

  static String m13(count) => "${count}  Articles";

  static String m14(country) => "${country}  pays n\'est pas pris en charge";
  ...
  static String m18(timeLeft) => "Termine en ${timeLeft}";
  ...
  static String m35(itemCount) => "${itemCount} produits";

  static String m36(price) => "Total des options: ${price}";

  static String m37(amount) => "Payer ${amount}";

  static String m38(name) => "${name} ont été ajoutés au panier avec succès";

  static String m39(total) => "Qté: ${total}";

  static String m40(name) => "J\'ai reçu de l\'argent de ${name}";

  static String m41(count) =>
      "Voulez-vous supprimer ${count} article(s) de votre liste de souhaits ?";

  static String m42(percent) => "Remise ${percent} %";

  static String m43(keyword) => "Résultats de recherche pour : \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count}  élément)";

  static String m45(keyword, count) => "${keyword} (${count}  éléments)";
  ...
  static String m48(numberOfUnitsSold) => "Vendus: ${numberOfUnitsSold}";
  ...
  static String m54(balance) => "Solde du portefeuille : ${balance}";

  static String m55(message) => "Notice: ${message}";
  ...
  static String m57(length) => "Nous avons trouvé ${length} produits";

  static String m58(week) => "Semaine ${week}";

  static String m59(name) => "Bienvenue ${name}";

  static String m60(year) => "Il y a ${year} ans";

  static String m61(count) => "Vous sélectionnez ${count} article(s)";

  static String m62(total) => "Vous etes affecté à la commande n°${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "Continuer à sélectionner l\'élément"),
        "continueToShipping":
        ...
        "myRating": MessageLookupByLibrary.simpleMessage("Ma note"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("À noter"),
