...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(currency) => "将货币更改为 ${currency}";

  static String m8(number) => " 剩余${number} 个字符";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} 点";
  ...
  static String m14(country) => " 不支持${country} 个国家/地区";
  ...
  static String m18(timeLeft) => "以 ${timeLeft}结尾";

  static String m19(captcha) => "输入 ${captcha} 确认：";

  static String m20(message) => "Error: ${message}";

  static String m21(message) => "错误： ${message}";

  static String m22(time) => "在 ${time}期满";

  static String m23(total) => ">${total} 公里";

  static String m24(hour) => "${hour} 小时前";

  static String m25(currentBalance) => "您的钱包里只剩下 ${currentBalance} ";

  static String m26(message) => "应用程序在请求数据期间出现问题，请联系管理员解决问题： ${message}";

  static String m27(currency, amount) => "使用此付款的最大金额为 ${currency} ${amount}";

  static String m28(size) => "档案大小上限： ${size} MB";

  static String m29(name, formattedPrice) => "${name}： ${formattedPrice}";

  static String m30(currency, amount) => "使用此付款的最低金额为 ${currency} ${amount}";

  static String m31(minute) => "${minute} 分钟钱";

  static String m32(month) => "${month} 个月前";

  static String m33(store) => " ${store}的更多内容";

  static String m34(number) => "必须以 ${number}为一组购买";

  static String m35(itemCount) => "${itemCount} 件商品";

  static String m36(price) => "选项总数： ${price}";

  static String m37(amount) => "支付 ${amount}";

  static String m38(name) => "${name} 已成功添加到购物车";
  ...
  static String m42(percent) => "出售${percent}%";

  static String m43(keyword) => "搜索结果：“${keyword}”";
  ...
  static String m49(fieldName) => " ${fieldName} 字段是必需的";

  static String m50(total) => "${total} 个产品";

  static String m51(name) => "转帐至 ${name}";
  ...
  static String m54(balance) => "钱包余额： ${balance}";
  ...
  static String m57(length) => "我们找到 ${length} 个产品";

  static String m58(week) => "周 ${week}";

  static String m59(name) => "欢迎 ${name}";

  static String m60(year) => "${year} 年前";

  static String m61(count) => "您正在选择 ${count} 个项目";

  static String m62(total) => "您已指定订单 #${total}";
