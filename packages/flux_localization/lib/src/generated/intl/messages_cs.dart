...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} nemůže být prázdné.";

  static String m6(fieldName) => " Délka${fieldName} nesmí být menší než 3.";

  static String m7(currency) => "Měna změněna na ${currency}";

  static String m8(number) => " Zbývající počet znaků:${number} ";

  static String m9(priceRate, pointRate) => "${priceRate} = ${pointRate} bodů";

  static String m10(count) => "${count} položka";

  static String m11(count) => " Položky:${count} ";

  static String m12(count) => "${count} položka";

  static String m13(count) => "${count} položek";

  static String m14(country) => "${country} země není podporována";

  static String m15(currency) => "${currency} není podporováno";
  ...
  static String m19(captcha) => "Zadejte ${captcha} pro potvrzení:";
  ...
  static String m33(store) => "Více od uživatele ${store}";

  static String m34(number) => "nutno zakoupit ve skupinách po ${number}";
  ...
  static String m38(name) => "${name} byly úspěšně přidány do košíku";

  static String m39(total) => "Množství: ${total}";

  static String m40(name) => "Přijaté peníze od ${name}";

  static String m41(count) =>
      "Chcete odebrat položky (celkem ${count} ) ze seznamu přání?";

  static String m42(percent) => "Výprodej ${percent}%";

  static String m43(keyword) => "Výsledky hledání pro: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} položka)";

  static String m45(keyword, count) => "${keyword} (počet položek:${count} )";

  static String m46(second) => " Před${second} s";
  ...
  static String m51(name) => "Převést peníze na ${name}";
  ...
  static String m53(date) => "Platí do ${date}";

  static String m54(balance) => "Zůstatek v peněžence: ${balance}";

  static String m55(message) => "Upozornění: ${message}";
  ...
  static String m57(length) => "Našli jsme ${length} produktů";

  static String m58(week) => "Týden ${week}";

  static String m59(name) => "Vítejte ${name}";

  static String m60(year) => " Před${year} lety";

  static String m61(count) => "Vybíráte položky (celkem ${count} )";

  static String m62(total) => "Přiřadili jste k objednávce č.${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Čeká na recenze"),
        ...
        "selectItem": MessageLookupByLibrary.simpleMessage("Vybrat předmět"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("Sdílejte produktová data"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("Sdílejte odkaz na produkt"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("Hodnotit"),
        ...
        "waiting": MessageLookupByLibrary.simpleMessage("Čekání"),
