...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} non può essere vuoto.";

  static String m6(fieldName) =>
      "La lunghezza di${fieldName} non deve essere inferiore a 3.";

  static String m7(currency) => "Valuta modificata in ${currency}";

  static String m8(number) => "${number} caratteri rimanenti";
  ...
  static String m12(count) => "${count} elemento";

  static String m13(count) => "${count} elementi";

  static String m14(country) => "${country} paese non è supportato";

  static String m15(currency) => " ${currency} non è supportato";
  ...
  static String m22(time) => "In scadenza tra ${time}";
  ...
  static String m28(size) => "Dimensione massima del file: ${size} MB";
  ...
  static String m33(store) => "Altro da ${store}";

  static String m34(number) => "deve essere acquistato in gruppi di ${number}";

  static String m35(itemCount) => "${itemCount} prodotti";

  static String m36(price) => "Opzioni totali: ${price}";
  ...
  static String m40(name) => "Ho ricevuto denaro da ${name}";

  static String m41(count) =>
      "Vuoi rimuovere ${count} articolo/i dalla tua lista dei desideri?";

  static String m42(percent) => "${percent}% di sconto";

  static String m43(keyword) => "Risultati della ricerca per: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (${count} elemento)";

  static String m45(keyword, count) => "${keyword} (${count} elementi)";
  ...
  static String m53(date) => "Valido fino alle ${date}";

  static String m54(balance) => "Saldo del portafoglio: ${balance}";

  static String m55(message) => "Attenzione: ${message}";
  ...
  static String m57(length) => "Abbiamo trovato \$length prodotti";

  static String m58(week) => "Settimana ${week}";

  static String m59(name) => "Benvenuto ${name}";

  static String m60(year) => "${year} anni fa";

  static String m61(count) => "Stai selezionando ${count} elemento/i";

  static String m62(total) => "Hai assegnato all\'ordine #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "Continua a selezionare l\'articolo"),
        "continueToShipping":
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Revisioni in sospeso"),
        ...
        "selectItem":
            MessageLookupByLibrary.simpleMessage("Seleziona elemento"),
        "selectNone":
        ...
        "shareProductData": MessageLookupByLibrary.simpleMessage(
            "Condividi i dati del prodotto"),
        "shareProductLink": MessageLookupByLibrary.simpleMessage(
            "Condividi il link del prodotto"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("Per valutare"),
