...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(currency) => "Valyuta ${currency}ga almashtirildi";
  ...
  static String m12(count) => "${count} ta element";

  static String m13(count) => "${count} ta element";

  static String m14(country) => "${country} ta mamlakat qoʻllab-quvvatlanmaydi";
  ...
  static String m19(captcha) => "Tasdiqlash uchun ${captcha} kiriting:";

  static String m20(message) => "Xato: ${message}";

  static String m21(message) => "Xato: ${message}";

  static String m22(time) => "Muddati: ${time}";
  ...
  static String m33(store) => "Yana ${store}";

  static String m34(number) => " ${number}ta guruhlarda sotib olinishi kerak";

  static String m35(itemCount) => "${itemCount} ta element";

  static String m36(price) => "Jami variantlar: ${price}";

  static String m37(amount) => " ${amount}toʻlash";

  static String m38(name) => "${name} savatga muvaffaqiyatli qo‘shildi";

  static String m39(total) => "Miqdor: ${total}";

  static String m40(name) => " ${name}dan pul olindi ";

  static String m42(percent) => "Sotish: ${percent}%";

  static String m43(keyword) => "Qidiruv natijalari: \'${keyword}\'";
  ...
  static String m48(numberOfUnitsSold) => "Sotilgan: ${numberOfUnitsSold}";

  static String m49(fieldName) => " ${fieldName} maydoni to\'ldirilishi shart";

  static String m50(total) => "${total} ta mahsulot";

  static String m51(name) => " ${name}hisobiga pul oʻtkazing ";
  ...
  static String m54(balance) => "Hamyon balansi: ${balance}";

  static String m55(message) => "Ogohlantirish: ${message}";
  ...
  static String m57(length) => "Biz ${length} ta mahsulotni topdik";

  static String m58(week) => " ${week}hafta";

  static String m59(name) => "Xush kelibsiz ${name}";

  static String m60(year) => "${year} yil oldin";

  static String m62(total) => "Siz buyurtma berdingiz:${total}";
