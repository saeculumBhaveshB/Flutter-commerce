...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} रिक्त नहीं हो सकता.";

  static String m6(fieldName) =>
      "${fieldName} की लंबाई 3 से कम नहीं होनी चाहिए.";

  static String m7(currency) => "मुद्रा को ${currency}में बदला गया";
  ...
  static String m12(count) => "${count} आइटम";
  ...
  static String m19(captcha) => "पुष्टि करने के लिए ${captcha} दर्ज करें:";
  ...
  static String m28(size) => "अधिकतम फ़ाइल आकार: ${size} एमबी";
  ...
  static String m33(store) => " ${store}से अधिक";

  static String m34(number) => " ${number}के समूह में खरीदा जाना चाहिए";

  static String m35(itemCount) => "${itemCount} आइटम";

  static String m36(price) => "विकल्प कुल: ${price}";

  static String m37(amount) => "भुगतान करें ${amount}";
  ...
  static String m40(name) => " ${name}से धन प्राप्त हुआ";

  static String m41(count) =>
      "क्या आप अपनी इच्छा सूची से ${count} आइटम हटाना चाहते हैं?";

  static String m42(percent) => "बिक्री ${percent} %";

  static String m43(keyword) => "इसके लिए खोज परिणाम: \'${keyword}\'";
  ...
  static String m50(total) => "${total} उत्पाद";

  static String m51(name) => " ${name}पर धन हस्तांतरित करें";
  ...
  static String m53(date) => "मान्य तिल ${date}";

  static String m54(balance) => "वॉलेट बैलेंस: ${balance}";

  static String m55(message) => "चेतावनी: ${message}";
  ...
  static String m57(length) => "हमें ${length} उत्पाद मिले";

  static String m58(week) => "सप्ताह ${week}";

  static String m59(name) => "आपका स्वागत है ${name}";

  static String m60(year) => "${year} साल पहले";

  static String m61(count) => "आप ${count} आइटम चुन रहे हैं";

  static String m62(total) => "आपने #${total}ऑर्डर करने के लिए असाइन किया है";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("आइटम का चयन जारी रखें"),
        "continueToShipping":
        ...
        "myReviews": MessageLookupByLibrary.simpleMessage("मेरी समीक्षा"),
        ...
        "selectItem": MessageLookupByLibrary.simpleMessage("आइटम का चयन करें"),
        "selectNone":
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("उत्पाद डेटा साझा करें"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("उत्पाद लिंक साझा करें"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("मूल्यांकन करना"),
