...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(currency) => "將貨幣更改為 ${currency}";

  static String m8(number) => " 剩餘${number} 個字符";
  ...
  static String m14(country) => " 不支持${country} 個國家/地區";

  static String m15(currency) => "${currency} 不受支持";

  static String m16(day) => "${day} 天前";

  static String m17(total) => "~${total} 公里";

  static String m18(timeLeft) => "以 ${timeLeft} 結尾";

  static String m19(captcha) => "輸入 ${captcha} 確認：";

  static String m20(message) => "錯誤： ${message}";

  static String m21(message) => "錯誤： ${message}";

  static String m22(time) => " ${time}到期";

  static String m23(total) => ">${total} 公里";

  static String m24(hour) => "${hour} 小時前";

  static String m25(currentBalance) => "您的錢包裡只剩下 ${currentBalance} ";

  static String m26(message) => "請求數據時應用出現問題，請聯繫管理員解決問題： ${message}";

  static String m27(currency, amount) => "使用此付款的最大金額為 ${currency} ${amount}";

  static String m28(size) => "最大文件大小： ${size} MB";

  static String m30(currency, amount) => "使用此付款的最低金額為 ${currency} ${amount}";

  static String m31(minute) => "${minute} 分鐘前";

  static String m32(month) => "${month} 個月前";

  static String m33(store) => " ${store}的更多內容";

  static String m34(number) => "必須以 ${number}為一組購買";

  static String m35(itemCount) => "${itemCount} 項";

  static String m36(price) => "選項總數： ${price}";
  ...
  static String m40(name) => "收到來自 ${name}的錢 ";

  static String m42(percent) => "銷售額 ${percent}%";

  static String m43(keyword) => "搜尋結果：“${keyword}”";
  ...
  static String m50(total) => "${total} 個商品";

  static String m51(name) => "轉帳至 ${name}";
  ...
  static String m54(balance) => "皮夾餘額： ${balance}";
  ...
  static String m57(length) => "我們找到了 ${length} 件商品";

  static String m58(week) => "第 ${week} 週";

  static String m59(name) => "歡迎 ${name}";

  static String m60(year) => "${year} 年前";

  static String m62(total) => "您已指定訂單 #${total}";
