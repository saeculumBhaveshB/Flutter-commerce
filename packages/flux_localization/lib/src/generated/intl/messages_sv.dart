...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} får inte vara tom.";

  static String m6(fieldName) =>
      " Längden${fieldName} får inte vara mindre än 3.";
  ...
  static String m12(count) => "${count} objekt";

  static String m13(count) => "${count} objekt";

  static String m14(country) => "${country} land stöds inte";
  ...
  static String m40(name) => "Fick pengar från ${name}";

  static String m41(count) =>
      "Vill du ta bort ${count} objekt från din önskelista?";

  static String m42(percent) => "Försäljning ${percent}%";
  ...
  static String m53(date) => "Gäller till ${date}";

  static String m54(balance) => "Saldo i plånbok: ${balance}";

  static String m55(message) => "Varning: ${message}";
  ...
  static String m57(length) => "Vi hittade ${length} produkter";

  static String m58(week) => "Vecka ${week}";

  static String m59(name) => "Välkommen ${name}";

  static String m60(year) => " För${year} år sedan";

  static String m61(count) => "Du väljer ${count} objekt(er)";

  static String m62(total) => "Du har tilldelat order nr${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("Fortsätt att välja objekt"),
        "continueToShipping":
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Väntar på recensioner"),
        ...
        "selectItem": MessageLookupByLibrary.simpleMessage("Välj föremål"),
        ...
        "waiting": MessageLookupByLibrary.simpleMessage("Väntan"),
