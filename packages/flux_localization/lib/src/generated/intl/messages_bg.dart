...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(currency) => "Променена валута на ${currency}";
  ...
  static String m13(count) => "${count} елемента";

  static String m14(country) => "Страната ${country} не се поддържа";

  static String m15(currency) => "${currency} не се поддържа";

  static String m16(day) => "${day} дни преди";

  static String m17(total) => "~${total} км";

  static String m18(timeLeft) => "Свършва след ${timeLeft}";

  static String m19(captcha) => "Въведете ${captcha}, за да потвърдите:";
  ...
  static String m24(hour) => "${hour} часа преди";
  ...
  static String m28(size) => "Максимален размер на файл: ${size} MB";

  static String m30(currency, amount) =>
      "Минималната сума за използване на този начин на плащане е ${currency} ${amount}";

  static String m31(minute) => "${minute} минути преди";

  static String m32(month) => "${month} месеца преди";

  static String m33(store) => "Още от ${store}";

  static String m34(number) => "трябва да се купува в групи от ${number}";

  static String m35(itemCount) => "${itemCount} артикула";

  static String m36(price) => "Обща стойност на опциите: ${price}";

  static String m37(amount) => "Платете ${amount}";

  static String m38(name) => "${name} са добавени успешно в количката";
  ...
  static String m43(keyword) => "Резултати от търсенето на: „${keyword}“";

  static String m44(keyword, count) => "${keyword} (${count} елемент)";

  static String m45(keyword, count) => "${keyword} (${count} елемента)";

  static String m46(second) => "${second} секунди преди";

  static String m47(totalCartQuantity) =>
      "Количка за пазаруване, ${totalCartQuantity} артикула";

  static String m48(numberOfUnitsSold) => "Продадено: ${numberOfUnitsSold}";

  static String m49(fieldName) => "Полето ${fieldName} е задължително";

  static String m50(total) => "${total} продукта";

  static String m51(name) => "Прехвърлете пари на ${name}";
  ...
  static String m53(date) => "Валидно до ${date}";

  static String m54(balance) => "Салдо в Wallet: ${balance}";

  static String m55(message) => "Предупреждение: ${message}";
  ...
  static String m57(length) => "Намерихме ${length} продукта";

  static String m58(week) => "Седмица ${week}";

  static String m59(name) => "Добре дошъл, ${name}";

  static String m60(year) => "${year} години преди";

  static String m62(total) => "Вие сте назначени за поръчка №${total}";
