...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(day) => "${day} gün öncə";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => " ${timeLeft}tarixində bitir";

  static String m19(captcha) => "Təsdiq etmək üçün ${captcha} daxil edin:";

  static String m20(message) => "Xəta: ${message}";

  static String m21(message) => "Xəta: ${message}";

  static String m22(time) => " ${time}tarixində başa çatır";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour} saat öncə";
  ...
  static String m31(minute) => "${minute} dəqiqə öncə";

  static String m32(month) => "${month} ay əvvəl";

  static String m33(store) => " ${store}saytından daha çox";
  ...
  static String m42(percent) => "Endirim ${percent}%";
  ...
  static String m46(second) => "${second} saniyə öncə";
  ...
  static String m54(balance) => "Pulqabı balansı: ${balance}";

  static String m55(message) => "Xəbərdarlıq: ${message}";
  ...
  static String m57(length) => "${length} məhsul tapıldı";

  static String m58(week) => "Həftə ${week}";

  static String m59(name) => "Xoş gəldiniz ${name}";

  static String m60(year) => "${year} il əvvəl";

  static String m61(count) => "Siz ${count} element(lər) seçirsiniz";

  static String m62(total) => "Siz №${total}sifarişi təyin etdiniz";
