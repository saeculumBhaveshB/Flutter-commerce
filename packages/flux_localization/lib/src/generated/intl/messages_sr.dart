...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(day) => "Пре ${day} Данa";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Завршава се у${timeLeft}";
  ...
  static String m22(time) => "Истиче ${time}";
  ...
  static String m31(minute) => "Пре ${minute} Minuten";
  ...
  static String m35(itemCount) => "${itemCount} Ставка";
  ...
  static String m42(percent) => "Распродај ${percent} %";
  ...
  static String m46(second) => "Пре ${second} Минута";
  ...
  static String m53(date) => "Датум истека ${date}";

  static String m54(balance) => "Стање у новчанику: ${balance}";

  static String m55(message) => "упозорење: ${message}";
  ...
  static String m57(length) => "Пронашли смо производе";

  static String m58(week) => " ${week}. Sedmica";

  static String m59(name) => "Добро дошли ${name}";

  static String m60(year) => " Prije${year} godina";

  static String m61(count) => "Бирате ${count} ставки(е)";

  static String m62(total) => "Dodijelili ste narudžbi br.${total}";
