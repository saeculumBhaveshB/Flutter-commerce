...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} は空にできません。";

  static String m6(fieldName) => "${fieldName} の長さは 3 未満であってはなりません。";
  ...
  static String m11(count) => "${count} アイテム";

  static String m12(count) => "${count} アイテム";

  static String m13(count) => "${count} 個のアイテム";

  static String m14(country) => "${country} 国はサポートされていません";
  ...
  static String m18(timeLeft) => "${timeLeft}で終了する";

  static String m19(captcha) => " ${captcha} を入力して確認します。";

  static String m20(message) => "エラー：${message}";

  static String m21(message) => "エラー: ${message}";

  static String m22(time) => " ${time}で期限切れ";

  static String m23(total) => ">${total} km";

  static String m24(hour) => "${hour}時間前";

  static String m25(currentBalance) => "ウォレットには ${currentBalance} しか残っていません";

  static String m26(message) =>
      "アプリでデータのリクエスト中に問題が発生しました。問題を解決するためには、管理者に連絡してください：${message}";

  static String m27(currency, amount) => "このお支払いの最大金額は ${currency} ${amount}です";

  static String m28(size) => "最大ファイルサイズ： ${size} MB";

  static String m29(name, formattedPrice) => "${name}: ${formattedPrice}";

  static String m30(currency, amount) => "このお支払いの最低金額は ${currency} ${amount}です";

  static String m31(minute) => "${minute}分前";

  static String m32(month) => "${month} か月前";

  static String m33(store) => " ${store}からの詳細";

  static String m34(number) => " ${number}のグループで購入する必要があります";

  static String m35(itemCount) => "${itemCount}個のアイテム";

  static String m36(price) => "オプションの合計： ${price}";

  static String m37(amount) => " ${amount}を支払う";

  static String m38(name) => "${name} がカートに正常に追加されました";

  static String m39(total) => "数量： ${total}";

  static String m40(name) => " ${name}からお金を受け取りました";

  static String m41(count) => "ウィッシュリストから ${count} 個のアイテムを削除しますか?";

  static String m42(percent) => "セール${percent}％";

  static String m43(keyword) => "検索結果: 「${keyword}」";

  static String m44(keyword, count) => "${keyword} (${count} 個のアイテム)";

  static String m45(keyword, count) => "${keyword} (${count} 個のアイテム)";
  ...
  static String m48(numberOfUnitsSold) => "販売済み：${numberOfUnitsSold}個";

  static String m49(fieldName) => " ${fieldName} フィールドは必須です";

  static String m50(total) => "${total} 製品";

  static String m51(name) => " ${name}に送金する";
  ...
  static String m54(balance) => "ウォレット残高: ${balance}";

  static String m55(message) => "警告：${message}";

  static String m56(defaultCurrency) =>
      "現在選択されている通貨はウォレット機能では利用できません。 ${defaultCurrency}に変更してください";

  static String m57(length) => "${length} 個の商品が見つかりました";

  static String m58(week) => "週 ${week}";

  static String m59(name) => "ようこそ ${name}";

  static String m60(year) => "${year} 年前";

  static String m61(count) => " ${count} 個のアイテムを選択しています";

  static String m62(total) => "注文番号${total}に割り当てました";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("アイテムの選択を続ける"),
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("画像をダウンロードしています..."),
        ...
        "myRating": MessageLookupByLibrary.simpleMessage("私の評価"),
        "myReviews": MessageLookupByLibrary.simpleMessage("私のレビュー"),
        ...
        "pendingReviews": MessageLookupByLibrary.simpleMessage("保留中のレビュー"),
        ...
        "removeWishlist": MessageLookupByLibrary.simpleMessage("ウィッシュリストから削除"),
        ...
        "shareProductData": MessageLookupByLibrary.simpleMessage("製品データを共有する"),
        "shareProductLink": MessageLookupByLibrary.simpleMessage("製品リンクを共有"),
