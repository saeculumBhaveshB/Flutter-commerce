...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(fieldName) =>
      "Die Länge von${fieldName} darf nicht kleiner als 3 sein.";

  static String m7(currency) => "Währung auf ${currency}geändert";

  static String m8(number) => "${number} verbleibende Zeichen";
  ...
  static String m13(count) => "${count} Elemente";

  static String m14(country) => "${country} Land wird nicht unterstützt";
  ...
  static String m19(captcha) => "Geben Sie ${captcha} ein, um zu bestätigen:";

  static String m20(message) => "Fehler: ${message}";

  static String m21(message) => "Fehler: ${message}";

  static String m22(time) => "Ablaufen in ${time}";
  ...
  static String m34(number) => "müssen in Gruppen von ${number}gekauft werden";

  static String m35(itemCount) => "${itemCount} Artikel";

  static String m36(price) => "Optionen insgesamt: ${price}";

  static String m37(amount) => "Zahlen Sie ${amount}";
  ...
  static String m41(count) =>
      "Möchten Sie ${count} Artikel aus Ihrer Wunschliste entfernen?";

  static String m42(percent) => "Ausverkauf ${percent} %";
  ...
  static String m51(name) => "Überweisen Sie Geld an ${name}";
  ...
  static String m54(balance) => "Wallet-Guthaben: ${balance}";

  static String m55(message) => "Warnung: ${message}";
  ...
  static String m57(length) => "Wir haben die Produkte gefunden";

  static String m58(week) => "Woche ${week}";

  static String m59(name) => "Willkommen ${name}";

  static String m60(year) => " Vor${year} Jahren";

  static String m61(count) => "Sie wählen ${count} Artikel aus";

  static String m62(total) => "Sie haben der Bestellung #${total}zugewiesen";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "removeWishlist":
            MessageLookupByLibrary.simpleMessage("Von Wunschliste entfernen"),
