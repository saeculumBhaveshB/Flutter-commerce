...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} nie może być pusty.";

  static String m6(fieldName) =>
      "Długość${fieldName} nie może być mniejsza niż 3.";

  static String m7(currency) => "Zmieniono walutę na ${currency}";

  static String m8(number) => " Pozostało${number} znaków";
  ...
  static String m13(count) => "${count} elementów";

  static String m14(country) => " Kraj${country} nie jest obsługiwany";

  static String m15(currency) => "${currency} nie jest obsługiwane";
  ...
  static String m34(number) => "należy kupować w grupach po ${number}";

  static String m35(itemCount) => "${itemCount} elementów";

  static String m36(price) => "Łącznie opcje: ${price}";

  static String m37(amount) => "Zapłać ${amount}";

  static String m38(name) => "${name} zostało pomyślnie dodane do koszyka";

  static String m39(total) => "Ilość: ${total}";

  static String m40(name) => "Otrzymano pieniądze od ${name}";

  static String m41(count) =>
      "Czy chcesz usunąć ${count} pozycji(y) ze swojej listy życzeń?";
  ...
  static String m45(keyword, count) => "${keyword} (${count} elementy)";

  static String m46(second) => "${second} sekundy temu";
  ...
  static String m51(name) => "Przelej pieniądze na ${name}";
  ...
  static String m54(balance) => "Saldo portfela: ${balance}";

  static String m55(message) => "Ostrzeżenie: ${message}";
  ...
  static String m57(length) => "Znaleźliśmy ${length} produktów";

  static String m58(week) => "Tydzień ${week}";

  static String m59(name) => "Witamy ${name}";

  static String m60(year) => "${year} lat temu";

  static String m61(count) => "Wybierasz ${count} elementów";

  static String m62(total) => "Przypisałeś do zamówienia nr${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "myReviews": MessageLookupByLibrary.simpleMessage("Moje recenzje"),
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Oczekujące recenzje"),
        ...
        "selectItem": MessageLookupByLibrary.simpleMessage("Wybierz element"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("Aby ocenić"),
