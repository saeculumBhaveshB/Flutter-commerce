...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(message) => "请求数据时应用出现问题，请联系管理员解决问题： ${message}";
  ...
  static String m35(itemCount) => "${itemCount} 项";
  ...
  static String m42(percent) => "销售额 ${percent}%";
  ...
  static String m57(length) => "我们找到了 ${length} 件商品";

  static String m58(week) => "第 ${week} 周";
