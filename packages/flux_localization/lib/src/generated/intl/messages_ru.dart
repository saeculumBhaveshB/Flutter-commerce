...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} не может быть пустым.";

  static String m6(fieldName) => "Длина${fieldName} не должна быть меньше 3.";

  static String m7(currency) => "Валюта изменена на ${currency}";

  static String m8(number) => " Осталось${number} символов";
  ...
  static String m13(count) => "${count} элементов";
  ...
  static String m22(time) => "Срок действия истекает через ${time}";
  ...
  static String m33(store) => "Еще от ${store}";

  static String m34(number) => "необходимо покупать группами по ${number}";

  static String m35(itemCount) => "${itemCount} товаров";

  static String m36(price) => "Всего вариантов: ${price}";

  static String m37(amount) => "Оплатить ${amount}";

  static String m38(name) => "${name} успешно добавлено в корзину";

  static String m39(total) => "Кол-во: ${total}";

  static String m40(name) => "Получил деньги от ${name}";

  static String m41(count) =>
      "Хотите удалить ${count} товар(ов) из вашего списка желаний?";

  static String m42(percent) => "Распродажа ${percent} %";

  static String m43(keyword) => "Результаты поиска для: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (элемент${count} )";

  static String m45(keyword, count) => "${keyword} (${count} шт.)";
  ...
  static String m50(total) => "${total} продуктов";

  static String m51(name) => "Перевести деньги на ${name}";
  ...
  static String m54(balance) => "Баланс кошелька: ${balance}";
  ...
  static String m57(length) => "Мы нашли товары";

  static String m58(week) => "Неделя ${week}";

  static String m59(name) => "Добро пожаловать ${name}";

  static String m60(year) => "${year} лет назад";

  static String m61(count) => "Вы выбираете ${count} элемент(ов)";

  static String m62(total) => "Вы назначили заказ №${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("Продолжить выбор элемента"),
        "continueToShipping":
        ...
        "loginRequired": MessageLookupByLibrary.simpleMessage("Требуется вход"),
        "loginSuccess":
        ...
        "myRating": MessageLookupByLibrary.simpleMessage("Мой рейтинг"),
        "myReviews": MessageLookupByLibrary.simpleMessage("Мои обзоры"),
        ...
        "shareProductData": MessageLookupByLibrary.simpleMessage(
            "Поделиться данными о продукте"),
        "shareProductLink": MessageLookupByLibrary.simpleMessage(
            "Поделиться ссылкой на продукт"),
