...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(number) => " Počet zostávajúcich znakov:${number} ";
  ...
  static String m13(count) => " Počet položiek:${count} ";

  static String m14(country) => "${country} krajina nie je podporovaná";

  static String m15(currency) => "${currency} nie je podporované";

  static String m16(day) => " pred${day} dňami";

  static String m17(total) => "~${total} km";

  static String m18(timeLeft) => "Končí o ${timeLeft}";

  static String m19(captcha) => "Zadajte ${captcha} na potvrdenie:";

  static String m20(message) => "Chyba: ${message}";

  static String m21(message) => "Chyba: ${message}";

  static String m22(time) => "Platnosť vyprší o ${time}";
  ...
  static String m33(store) => "Viac od používateľa ${store}";

  static String m34(number) => "je potrebné zakúpiť v skupinách po ${number}";

  static String m35(itemCount) => " ${itemCount} položiek";

  static String m36(price) => "Celkom: ${price}";

  static String m37(amount) => "Zaplatiť ${amount}";

  static String m38(name) => "${name} boli úspešne pridané do košíka";
  ...
  static String m45(keyword, count) => "${keyword} (počet položiek:${count} )";

  static String m46(second) => " pred ${second} sek.";
  ...
  static String m51(name) => "Previesť peniaze na ${name}";
  ...
  static String m54(balance) => "Zostatok v Peňaženke: ${balance}";

  static String m55(message) => "Upozornenie: ${message}";

  static String m56(defaultCurrency) =>
      "Aktuálna mena nie je dostupná pre funkciu Peňaženka. Zmeňte ju na ${defaultCurrency}";

  static String m57(length) => "Našli sme ${length} produktov";

  static String m58(week) => " ${week}. týždeň";

  static String m59(name) => "Vitajte ${name}";

  static String m60(year) => " pred${year} rokmi";

  static String m62(total) => "Pridelili ste objednávke č.${total}";
