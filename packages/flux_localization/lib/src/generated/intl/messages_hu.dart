...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(fieldName) =>
      "${fieldName} hossza nem lehet kevesebb 3-nál.";

  static String m7(currency) => "Pénznem módosítva erre: ${currency}";

  static String m8(number) => "${number} karakter maradt";
  ...
  static String m12(count) => "${count} elem";

  static String m13(count) => "${count} elem";

  static String m14(country) => "${country} ország nem támogatott";
  ...
  static String m33(store) => "Továbbiak innen: ${store}";

  static String m34(number) => " ${number}csoportban kell megvásárolni";

  static String m35(itemCount) => "${itemCount} termékek";

  static String m36(price) => "Opciók összesen: ${price}";

  static String m37(amount) => "Fizetés: ${amount}";

  static String m38(name) => "${name} sikeresen bekerült a kosárba";

  static String m39(total) => "Mennyiség: ${total}";

  static String m40(name) => "Pénz érkezett tőle: ${name}";

  static String m41(count) => "Eltávolít ${count} elemet a kívánságlistájáról?";

  static String m42(percent) => "${percent} % Kedvezmény";

  static String m43(keyword) =>
      "Keresési eredmények a következőre: \"${keyword}\"";

  static String m44(keyword, count) => "${keyword} (${count} elem)";

  static String m45(keyword, count) => "${keyword} (${count} elem)";
  ...
  static String m49(fieldName) => "A(z) ${fieldName} mező kitöltése kötelező";

  static String m50(total) => "${total} termék";

  static String m51(name) => "Pénz utalása ide: ${name}";
  ...
  static String m54(balance) => "Wallet-egyenleg: ${balance}";

  static String m55(message) => "Figyelmeztetés: ${message}";
  ...
  static String m57(length) => "Találtunk ${length} terméket";

  static String m58(week) => " ${week}hét";

  static String m59(name) => "Üdvözöljük ${name}";

  static String m60(year) => "${year} évvel ezelőtt";

  static String m61(count) => "Ön ${count} elemet választ ki";

  static String m62(total) => "Hozzárendelte a (z)${total}számú megrendelést";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem": MessageLookupByLibrary.simpleMessage(
            "Folytassa az elem kiválasztásával"),
        "continueToShipping":
        ...
        "images": MessageLookupByLibrary.simpleMessage("képeket"),
        ...
        "myReviews": MessageLookupByLibrary.simpleMessage("Véleményeim"),
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Függőben lévő vélemények"),
        ...
        "selectItem":
            MessageLookupByLibrary.simpleMessage("Válassza ki az elemet"),
        ...
        "shareProductData":
            MessageLookupByLibrary.simpleMessage("Ossza meg a termékadatokat"),
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("Ossza meg a terméklinket"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("Értékelni"),
