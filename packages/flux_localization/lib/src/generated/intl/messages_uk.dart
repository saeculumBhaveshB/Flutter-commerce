...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(fieldName) =>
      " Довжина${fieldName} не повинна бути менше 3.";

  static String m7(currency) => "Змінено валюту на ${currency}";

  static String m8(number) => " Залишилося символів:${number} ";
  ...
  static String m12(count) => "${count} елемент";

  static String m13(count) => "${count} елементів";
  ...
  static String m19(captcha) => "Введіть ${captcha} , щоб підтвердити:";

  static String m20(message) => "Помилка: ${message}";

  static String m21(message) => "Помилка: ${message}";

  static String m22(time) => "Термін дії закінчується через ${time}";
  ...
  static String m34(number) => "потрібно купувати групами по ${number}";

  static String m35(itemCount) => "${itemCount} елементів";

  static String m36(price) => "Всього варіантів: ${price}";

  static String m37(amount) => "Сплатити ${amount}";

  static String m38(name) => "${name} успішно додано до кошика";

  static String m39(total) => "Кількість: ${total}";

  static String m40(name) => "Отримано гроші від ${name}";

  static String m41(count) =>
      "Бажаєте вилучити стільки елементів: ${count} зі свого списку бажань?";

  static String m42(percent) => "Продаж ${percent}%";

  static String m43(keyword) => "Результати пошуку для: \"${keyword}\"";

  static String m44(keyword, count) => "${keyword} (${count} елемент)";

  static String m45(keyword, count) => "${keyword} (${count} елементів)";
  ...
  static String m49(fieldName) => "Поле ${fieldName} є обов’язковим";

  static String m50(total) => "${total} продуктів";

  static String m51(name) => "Переказ грошей на ${name}";
  ...
  static String m53(date) => "Діє до ${date}";

  static String m54(balance) => "Баланс гаманця: ${balance}";

  static String m55(message) => "Попередження: ${message}";

  static String m56(defaultCurrency) =>
      "Вибрана валюта зараз недоступна для функції Wallet. Змініть її на ${defaultCurrency}";

  static String m57(length) => "Ми знайшли ${length} продуктів";

  static String m58(week) => "Тиждень ${week}";

  static String m59(name) => "Ласкаво просимо ${name}";

  static String m60(year) => "${year} років тому";

  static String m61(count) => "Ви вибираєте стільки елементів: ${count} ";

  static String m62(total) => "Ви призначили замовлення №${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "myRating": MessageLookupByLibrary.simpleMessage("Мій рейтинг"),
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("Очікує на розгляд"),
        ...
        "selectImage":
            MessageLookupByLibrary.simpleMessage("Виберіть зображення"),
        "selectItem": MessageLookupByLibrary.simpleMessage("Виберіть елемент"),
        "selectNone":
        ...
        "shareProductData": MessageLookupByLibrary.simpleMessage(
            "Поділіться даними про продукт"),
        "shareProductLink": MessageLookupByLibrary.simpleMessage(
            "Поділіться посиланням на продукт"),
