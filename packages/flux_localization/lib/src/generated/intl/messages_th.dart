...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(currency) => " ไม่รองรับ${currency} ";

  static String m16(day) => "${day} วันที่ผ่านมา";
  ...
  static String m24(hour) => "${hour} ชั่วโมงที่ผ่านมา";
  ...
  static String m42(percent) => "ยอดขาย ${percent} %";
  ...
  static String m46(second) => "${second} วินาทีที่ผ่านมา";

  static String m47(totalCartQuantity) =>
      "รายการสินค้าในรถเข็น ${totalCartQuantity}";

  static String m48(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m49(fieldName) => "ต้องระบุช่อง ${fieldName} ";

  static String m50(total) => "${total} สินค้า";
  ...
  static String m54(balance) => "ยอดเงินในกระเป๋าเงิน: ${balance}";

  static String m55(message) => "คำเตือน: ${message}";
  ...
  static String m57(length) => "เราพบสินค้า ${length}";

  static String m58(week) => "สัปดาห์ ${week}";

  static String m59(name) => "ยินดีต้อนรับ ${name}";

  static String m60(year) => "${year} ปีที่แล้ว";

  static String m61(count) => "คุณกำลังเลือก ${count} รายการ";

  static String m62(total) => "คุณได้มอบหมายคำสั่งซื้อ #${total}";
