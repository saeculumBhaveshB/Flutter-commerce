...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "${fieldName} kan niet leeg zijn.";

  static String m6(fieldName) =>
      "De lengte van${fieldName} mag niet kleiner zijn dan 3.";

  static String m7(currency) => "Valuta gewijzigd in ${currency}";
  ...
  static String m14(country) => "${country} land wordt niet ondersteund";
  ...
  static String m42(percent) => "Verkoop ${percent} %";
  ...
  static String m54(balance) => "Saldo portemonnee: ${balance}";

  static String m55(message) => "Waarschuwing: ${message}";
  ...
  static String m57(length) => "We hebben ${length} producten gevonden";

  static String m58(week) => "Week ${week}";

  static String m59(name) => "Welkom ${name}";

  static String m60(year) => "${year} jaar geleden";

  static String m61(count) => "U selecteert ${count} item(s)";

  static String m62(total) => "Je hebt toegewezen aan bestelling #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "pendingReviews": MessageLookupByLibrary.simpleMessage(
            "In afwachting van beoordelingen"),
        ...
        "toRate": MessageLookupByLibrary.simpleMessage("Om te beoordelen"),
