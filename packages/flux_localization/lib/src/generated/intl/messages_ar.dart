...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(fieldName) => "لا يمكن أن يكون${fieldName} فارغًا.";

  static String m6(fieldName) => "${fieldName} الطول لا يجب أن يكون أقل من 3.";
  ...
  static String m11(count) => "${count} من العناصر";

  static String m12(count) => "${count} عنصر";

  static String m13(count) => "${count} عناصر";

  static String m14(country) => " البلد${country} غير مدعوم";

  static String m15(currency) => " ${currency} غير مدعوم";

  static String m16(day) => "${day} أيام  ماضية";
  ...
  static String m23(total) => ">${total} كم";

  static String m24(hour) => "${hour} ساعات ماضية";
  ...
  static String m28(size) => "أقصى حجم للملف: ${size} ميغابايت";
  ...
  static String m31(minute) => "${minute} دقائق ماضية";

  static String m32(month) => " قبل${month} شهر";

  static String m33(store) => "المزيد من ${store}";

  static String m34(number) => "يجب شراؤها في مجموعات من ${number}";
  ...
  static String m38(name) => " تمت إضافة${name} إلى سلة التسوق بنجاح";

  static String m39(total) => "الكمية: ${total}";

  static String m40(name) => "استلمت مالاً من ${name}";

  static String m41(count) =>
      "هل تريد إزالة ${count} عنصرًا من قائمة الرغبات الخاصة بك؟";

  static String m42(percent) => "بيع ${percent} ٪";

  static String m43(keyword) => "نتائج البحث عن: \'${keyword}\'";

  static String m44(keyword, count) => "${keyword} (عنصر واحد ${count} )";

  static String m45(keyword, count) => "${keyword} (${count} عنصر)";

  static String m46(second) => "${second} ثواني ماضية";

  static String m47(totalCartQuantity) =>
      "سلة التسوق, تحتوي ${totalCartQuantity} عنصر";

  static String m48(numberOfUnitsSold) => "مباع: ${numberOfUnitsSold}";

  static String m49(fieldName) => "الحقل ${fieldName} مطلوب";

  static String m50(total) => "${total} من المنتجات";

  static String m51(name) => "نقل الأموال إلى ${name}";
  ...
  static String m54(balance) => "رصيد المحفظة: ${balance}";

  static String m55(message) => "تحذير: ${message}";

  static String m56(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة ، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m57(length) => "تم العثور على${length} منتجاً";

  static String m58(week) => "الأسبوع ${week}";

  static String m59(name) => "مرحبًا ${name}";

  static String m60(year) => " قبل${year} سنة";

  static String m61(count) => "أنت تقوم باختيار ${count} عنصر";

  static String m62(total) => "لقد قمت بتعيين الطلب رقم${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "continueToSelectItem":
            MessageLookupByLibrary.simpleMessage("متابعة لتحديد العنصر"),
        "continueToShipping":
        ...
        "downloadingImages":
            MessageLookupByLibrary.simpleMessage("جاري تنزيل الصور..."),
        ...
        "loginRequired":
            MessageLookupByLibrary.simpleMessage("مطلوب تسجيل الدخول"),
        "loginSuccess":
        ...
        "pendingReviews":
            MessageLookupByLibrary.simpleMessage("المراجعات المعلقة"),
        ...
        "shareProductLink":
            MessageLookupByLibrary.simpleMessage("شارك رابط المنتج"),
        ...
        "waiting": MessageLookupByLibrary.simpleMessage("في انتظار"),
