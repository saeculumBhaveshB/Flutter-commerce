...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m35(itemCount) => "${itemCount} mặt hàng";
  ...
  static String m39(total) => "Số lượng: ${total}";
  ...
  static String m42(percent) => "Sale ${percent} %";
  ...
  static String m53(date) => "Có hiệu lực cho đến ${date}";

  static String m54(balance) => "Số dư trên ví: ${balance}";

  static String m55(message) => "Cảnh báo: ${message}";
  ...
  static String m57(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m58(week) => "Tuần ${week}";

  static String m59(name) => "Chào mừng ${name}";

  static String m60(year) => "${year} năm trước";

  static String m61(count) => "Bạn đang chọn ${count} mục";

  static String m62(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
